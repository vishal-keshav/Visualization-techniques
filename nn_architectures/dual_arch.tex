...
\draw [connection] (convolution1-east) -- node { \pointwiseop} (4,0,0);
...
\draw [connection] (pointwise1-east) -- node { \pointwiseop} (6,0,0);
...
\draw [connection] (pointwise2pool-east) -- node { \depthwiseop} (8,0,0);
...
\draw [connection] (depthwise1-east) -- node { \depthwiseop} (10,0,0);
...
\draw [connection] (depthwise1pool-east) -- node { \pointwiseop} (12,0,0);
...
\draw [connection] (pointwise3-east) -- node { \pointwiseop} (14,0,0);
...
\draw [connection] (pointwise4pool-east) -- node { \upconvop} (16,0,0);
...
\draw [connection] (upconv1-east) -- node { \genericconvop} (18,0,0);
...
\draw [connection] (convolution2-east) -- node { \upconvop} (20,0,0);
...
\draw [connection] (upconv2-east) -- node { \genericconvop} (22,0,0);

\pic[shift={(22,0,0)}] at (0,0,0)
	{ Box={ name=convolution3,caption= convolution3,xlabel={ { "", } }, ylabel = , zlabel = ,
	fillface=genericconvdark,
	fillfront=genericconvlight,
	fill=genericconv, height=18,width=3,depth=18 } };

\draw [connection] (convolution3-east) -- node { \upconvop} (24,0,0);
...
\draw [connection] (upconv3-east) -- node { \genericconvop} (26,0,0);

\node[canvas is zy plane at x=0] (out.jpeg) at (26,0,0)
